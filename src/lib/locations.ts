...
export const HYD_LOCATIONS: LocationData[] = [
  ...
  { slug: "patancheruvu", name: "Patancheruvu", state: "Telangana", intro: "Premium SS316 invisible grills and ceiling cloth hangers for Patancheruvu industrial and residential communities.", context: "Serving workers' apartments and family homes across Patancheruvu industrial area with affordable, high-quality invisible safety solutions." },
  { slug: "sangareddy", name: "Sangareddy", state: "Telangana", intro: "Modern invisible grills and ceiling cloth hangers for Sangareddy's growing residential sector.", context: "From Sangareddy town to surrounding villages, families trust Sleek Secure for child-safe, view-preserving balcony and window protection." },
  { slug: "medchal", name: "Medchal", state: "Telangana", intro: "Premium SS316 invisible grills and space-saving ceiling cloth hangers for Medchal apartments and villas.", context: "Ideal for Medchal's emerging residential communities where modern safety meets clean architecture." },
